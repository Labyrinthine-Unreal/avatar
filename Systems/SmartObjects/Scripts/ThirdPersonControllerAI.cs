...
namespace StarterAssets
{
	...
	public class ThirdPersonControllerAI : Agent
	{
		[Header("Player")]
		...
		public override void CollectObservations(VectorSensor sensor)
		{
			...
			// Debug.Log(sensor.AddObservation(Target.position));
			sensor.AddObservation(thisAgent.transform.position);
			sensor.AddObservation(thisAgent.velocity.x);
			sensor.AddObservation(thisAgent.velocity.z);
		}
